...
REPLACED Section, SchoolYear, AcademicGrade, AcademicLevel, AcademicSublevel
from apps.students.models import Student, StudentRepresentative, Enrollment
from apps.grading.evaluation import EvaluativeActivity, BlockComponent, EvaluationBlock
...
class RowLevelSecurityTestCase(TestCase):
    ...
    def test_teacher_only_views_their_assigned_courses(self):
        ...
        response = self.client.get("/api/academic/teacher-subject-sections/")
