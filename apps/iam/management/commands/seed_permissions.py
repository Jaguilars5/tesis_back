...
def _build_catalog():
    ...
    for module_name, perms in modules:
        ...
        description_overrides = {
            ...
            "people.create_city": "Crear ciudades",
            "people.update_city": "Actualizar ciudades",
            "people.delete_city": "Eliminar ciudades",
            ...
            "students.create_special_needs_type": "Crear tipos de NEE",
            "students.update_special_needs_type": "Actualizar tipos de NEE",
            "students.delete_special_needs_type": "Eliminar tipos de NEE",
