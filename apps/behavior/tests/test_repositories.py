...
from apps.behavior.repositories.skill_evaluation_repository import SkillEvaluationRepository
from apps.behavior.repositories.socioemotional_skill_repository import SocioemotionalSkillRepository
...
class BehaviorRepositoryTest(TestCase):
    ...
    def test_socioemotional_skill_inactive(self):
        sk = SocioemotionalSkill.objects.create(code="INACT", name="Inactiva", is_active=False)
