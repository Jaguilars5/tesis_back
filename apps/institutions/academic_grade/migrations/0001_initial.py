    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_sublevel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='institutions_academic_sublevel.academicsublevel', verbose_name='Subnivel Academico')),
            ],
            options={
